...
private:
    ...
    bool check_diagonal_win(std::vector<std::tuple<uint8_t, uint8_t, mark>>& board_part) const;
    bool check_row_column_win(const std::vector<std::tuple<uint8_t, uint8_t, mark>>& board_part) const;
